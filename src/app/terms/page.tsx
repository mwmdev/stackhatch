      ...
      <article className="space-y-8 text-[0.9375rem] leading-7 text-[var(--muted-foreground)]">
        <section>
          ...
          <p className="mt-2">
            ...
            provide shared project access. Generated maps are explanations, not a complete audit of
            a codebase. Users are responsible for reviewing output before relying on it for
            production engineering decisions.
          </p>
        </section>

        <section>
          <h2 className="text-lg font-semibold text-[var(--foreground)]">Accounts and AI Usage</h2>
          <p className="mt-2">
        ...
        <section>
          ...
          <p className="mt-2">
            Users may not attempt to bypass access controls, abuse AI or repository scanning, upload
            content they do not have permission to use, or use StackHatch to violate applicable law.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="mt-2">
            For account or product support, contact support@stackhatch.io from the email associated
            with the account.
          </p>
        </section>
      </article>
